...
[#include "mpi.h"
   ...
   MPIINCLUDE=`echo $MPIINCLUDE | sed 's/[ \t][ \t]*/ /g'`
   MPIINCLUDE=`echo $MPIINCLUDE | sed "s/' /'/"`
   MPILIBDIRS=`echo $MPILIBDIRS | sed 's/[ \t][ \t]*/ /g'`
   MPILIBDIRS=`echo $MPILIBDIRS | sed "s/' /'/"`
   MPILIBS=`echo $MPILIBS | sed 's/[ \t][ \t]*/ /g'`
   MPILIBS=`echo $MPILIBS | sed "s/' /'/"`
   MPIFLAGS=`echo $MPIFLAGS | sed 's/[ \t][ \t]*/ /g'`
   MPIFLAGS=`echo $MPIFLAGS | sed "s/' /'/"`
