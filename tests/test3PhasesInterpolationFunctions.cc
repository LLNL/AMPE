...
int main(int argc, char *argv[])
{
...

   {
      ...
      double phi = 0.2;
      double val0 = g0(1. - phi, phi, 0.);
      double val1 = 1. - g0(phi, 1. - phi, 0.);
    ...
    */
   {
      ...
      double eps = 1.e-8;
      double val0 = g0(p0, p1, p2);
      double val1 = g0(p0 + 2. * eps / 3., p1 - eps / 3., p2 - eps / 3.);
      double deriv0 = (val1 - val0) / eps;
      double deriv1 = dg0dp0(p0, p1, p2);
      ...
      val0 = g0(p0, p1, p2);
      val1 = g0(p0 - eps / 3., p1 + 2. * eps / 3., p2 - eps / 3.);
