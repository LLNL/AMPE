...
class PatchDataTestStrategy
{
 public:
    ...
    */
   PatchDataTestStrategy(const SAMRAI::tbox::Dimension& dim);
   ...
   ///
   std::shared_ptr<SAMRAI::geom::CartesianGridGeometry> getGridGeometry() const
   {
    ...
    */
   void setDataContext(std::shared_ptr<SAMRAI::hier::VariableContext> context)
   {
      TBOX_ASSERT(context);
   ...
   ///
   std::shared_ptr<SAMRAI::hier::VariableContext> getDataContext() const
   {
      return d_data_context;
   }

   void clearDataContext() { d_data_context.reset(); }

   /**
    * Read variable parameters from input database.
    */
   void readVariableInput(std::shared_ptr<SAMRAI::tbox::Database> db);
   ...
   virtual void setPhysicalBoundaryConditions(
       const SAMRAI::hier::Patch& patch, const double time,
       const SAMRAI::hier::IntVector& gcw) const;

   ///
   virtual void preprocessRefine(const SAMRAI::hier::Patch& fine,
                                 const SAMRAI::hier::Patch& coarse,
                                 const SAMRAI::hier::Box& fine_box,
                                 const SAMRAI::hier::IntVector& ratio) const;

   ///
   virtual void postprocessRefine(const SAMRAI::hier::Patch& fine,
                                  const SAMRAI::hier::Patch& coarse,
                                  const SAMRAI::hier::Box& fine_box,
                                  const SAMRAI::hier::IntVector& ratio) const;

   ///
   virtual void preprocessCoarsen(const SAMRAI::hier::Patch& coarse,
                                  const SAMRAI::hier::Patch& fine,
                                  const SAMRAI::hier::Box& coarse_box,
                                  const SAMRAI::hier::IntVector& ratio) const;

   ///
   virtual void postprocessCoarsen(const SAMRAI::hier::Patch& coarse,
                                   const SAMRAI::hier::Patch& fine,
                                   const SAMRAI::hier::Box& coarse_box,
                                   const SAMRAI::hier::IntVector& ratio) const;
   ...
   virtual void initializeDataOnPatch(
       ...
       int level_number, char src_or_dst) = 0;
   /**
   ...
   virtual void setDataIds(std::list<int>& data_ids) { NULL_USE(data_ids); }

   virtual bool verifyCompositeBoundaryData(
       const SAMRAI::hier::Patch& patch,
       const std::shared_ptr<SAMRAI::hier::PatchHierarchy> hierarchy,
       int data_id, int level_number,
       const std::vector<std::shared_ptr<SAMRAI::hier::PatchData> >& bdry_data)
   {
      NULL_USE(patch);
      NULL_USE(hierarchy);
      NULL_USE(data_id);
 ...
 protected:
   ...
   std::vector<SAMRAI::hier::IntVector> d_variable_src_ghosts;
   std::vector<SAMRAI::hier::IntVector> d_variable_dst_ghosts;
 ...
 private:
   ...
   std::shared_ptr<SAMRAI::hier::VariableContext> d_data_context;
};
