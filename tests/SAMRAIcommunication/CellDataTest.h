...
class CellDataTest : public PatchDataTestStrategy
{
 public:
    ...
    */
   CellDataTest(const std::string& object_name,
                const SAMRAI::tbox::Dimension& dim,
                std::shared_ptr<SAMRAI::tbox::Database> main_input_db,
                bool do_refine, bool do_coarsen,
   ...
   void setPhysicalBoundaryConditions(
       ...
       const SAMRAI::hier::IntVector& gcw_to_fill) const;
   ...
   virtual void initializeDataOnPatch(
       ...
       int level_number, char src_or_dst);
   ...
   void setDataIds(std::list<int>& data_ids);

   bool verifyCompositeBoundaryData(
       const SAMRAI::hier::Patch& patch,
       const std::shared_ptr<SAMRAI::hier::PatchHierarchy> hierarchy,
 ...
 private:
    ...
    */
   void readTestInput(std::shared_ptr<SAMRAI::tbox::Database> db);

   /**
    * Set linear function data for testing interpolation
    */
   void setLinearData(
       std::shared_ptr<SAMRAI::pdat::CellData<CELL_KERNEL_TYPE> > data,
       const SAMRAI::hier::Box& box, const SAMRAI::hier::Patch& patch) const;

   /**
    * Set conservative linear function data for testing coarsening
    */
   void setConservativeData(
       std::shared_ptr<SAMRAI::pdat::CellData<CELL_KERNEL_TYPE> > data,
       const SAMRAI::hier::Box& box, const SAMRAI::hier::Patch& patch,
       const std::shared_ptr<SAMRAI::hier::PatchHierarchy> hierarchy,
   ...
   void checkPatchInteriorData(
       const std::shared_ptr<SAMRAI::pdat::CellData<CELL_KERNEL_TYPE> >& data,
       const SAMRAI::hier::Box& interior,
    ...
    */
   std::shared_ptr<SAMRAI::geom::CartesianGridGeometry> d_cart_grid_geometry;
   ...
   std::vector<std::shared_ptr<SAMRAI::hier::Variable> > d_variables;
};
#endif
