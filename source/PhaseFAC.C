...
extern "C" {
void SAMRAI_F77_FUNC(phasesetexactandrhs2d, PHASESETEXACTANDRHS2D) (const int& ifirst0,
   const int& ilast0,
   const int& ifirst1,
   const int& ilast1,
   double* exact,
...
void SAMRAI_F77_FUNC(phasesetexactandrhs3d, PHASESETEXACTANDRHS3D) (const int& ifirst0,
   const int& ilast0,
   const int& ifirst1,
   const int& ilast1,
   const int& ifirst2,
   ...
   for (hier::PatchLevel::iterator pi(level->begin());
       ...
       */
         ...
         SAMRAI_F77_FUNC(phasesetexactandrhs2d, PHASESETEXACTANDRHS2D) (
            pbox.lower()[0], pbox.upper()[0],
            pbox.lower()[1], pbox.upper()[1],
   ...
   string phase_well_func_type)
{
   ...
   d_poisson_fac_solver->setOperatorCoefficients(d_exact_id,
      -1, // no third phase
      d_mobility_id,d_epsilon,d_gamma,phase_interp_func_type,
 ...
 *************************************************************************
 */
bool PhaseFAC::packDerivedDataIntoDoubleBuffer(
   double* buffer,
