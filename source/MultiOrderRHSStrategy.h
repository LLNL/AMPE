...
#ifndef included_MultiOrderRHSStrategy
#define included_MultiOrderRHSStrategy
...
class MultiOrderRHSStrategy : public PhaseRHSStrategy
{
 public:
   ...
   ///
   /// Enforce constraint sum_i phi_i = 1 for CVODE
   ///
