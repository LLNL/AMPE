...
void QuadraticFreeEnergyStrategyMultiOrderThreePhase ::computeDerivFreeEnergy(
...
void QuadraticFreeEnergyStrategyMultiOrderThreePhase::addDrivingForceOnPatch(
...
void QuadraticFreeEnergyStrategyMultiOrderThreePhase::computeMuL(
...
void QuadraticFreeEnergyStrategyMultiOrderThreePhase::computeMuA(
    const double t, const double c0, const double c1, double* mu)
{
   double c[2] = {c0, c1};
   d_quadratic_fenergy->computeDerivFreeEnergy(t, c,
...
void QuadraticFreeEnergyStrategyMultiOrderThreePhase::computeMuB(
    const double t, const double c0, const double c1, double* mu)
{
   double c[2] = {c0, c1};
   d_quadratic_fenergy->computeDerivFreeEnergy(t, c,
