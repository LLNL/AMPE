...
class SundialsAbstractVector
{
 public:
    ...
    */
   virtual void setLinearSum(const double a, const SundialsAbstractVector* x,
                             const double b,
   ...
   /**
    * Set each entry of this vector: \f$v_i = x_i / y_i\f$, where \f$x_i, y_i\f$
    * are entries in vectors \f$x\f$ and \f$y\f$.  Based on the Sundials vector
    ...
    * entry entry in vector \f$x\f$.  Based on the Sundials vector
   ...
   /**
    * Return \f$0\f$ if \f$x_i \neq 0\f$ and \f$x_i z_i \leq 0\f$, for some
    * \f$i\f$. Here \f$z_i\f$ is an element of this vector. Otherwise, return
    * \f$1\f$.
    */
   ...
   /**
    * Set each entry of this vector: \f$v_i =  1 / x_i\f$, where \f$x_i\f$ is an
    * entry entry in the vector \f$x\f$, unless \f$x_i = 0\f$.  If \f$x_i =
    ...
    */
   N_Vector getNVector() { return d_n_vector; }
 ...
 private:
   ...
   static void N_VLinearSum_SAMRAI(realtype a, N_Vector x, realtype b,
   ...
   // static realtype N_VWrmsNormMask_SAMRAI(N_Vector x, N_Vector w, N_Vector
   // id);
