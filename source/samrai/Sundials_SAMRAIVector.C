...
void Sundials_SAMRAIVector::setToScalar(const double c)
{
   d_samrai_vector->setToScalar(c);
}

void Sundials_SAMRAIVector::scaleVector(const SundialsAbstractVector* x,
                                        const double c)
{
   d_samrai_vector->scale(c, SKVEC_CAST(x)->getSAMRAIVector());
}

void Sundials_SAMRAIVector::setLinearSum(const double a,
                                         const SundialsAbstractVector* x,
                                         const double b,
                                         const SundialsAbstractVector* y)
{
   d_samrai_vector->linearSum(a, SKVEC_CAST(x)->getSAMRAIVector(), b,
                              SKVEC_CAST(y)->getSAMRAIVector());
}

void Sundials_SAMRAIVector::pointwiseMultiply(const SundialsAbstractVector* x,
                                              const SundialsAbstractVector* y)
{
...
void Sundials_SAMRAIVector::pointwiseDivide(const SundialsAbstractVector* x,
                                            const SundialsAbstractVector* y)
{
...
void Sundials_SAMRAIVector::setAbs(const SundialsAbstractVector* x)
{
   d_samrai_vector->abs(SKVEC_CAST(x)->getSAMRAIVector());
}

void Sundials_SAMRAIVector::pointwiseReciprocal(const SundialsAbstractVector* x)
{
   d_samrai_vector->reciprocal(SKVEC_CAST(x)->getSAMRAIVector());
}

void Sundials_SAMRAIVector::addScalar(const SundialsAbstractVector* x,
                                      const double b)
{
   d_samrai_vector->addScalar(SKVEC_CAST(x)->getSAMRAIVector(), b);
}

double Sundials_SAMRAIVector::dotWith(const SundialsAbstractVector* x) const
{
...
double Sundials_SAMRAIVector::weightedL2Norm(
    const SundialsAbstractVector* x) const
{
   return d_samrai_vector->weightedL2Norm(SKVEC_CAST(x)->getSAMRAIVector());
}

double Sundials_SAMRAIVector::weightedRMSNorm(
    const SundialsAbstractVector* x) const
{
   return d_samrai_vector->weightedRMSNorm(SKVEC_CAST(x)->getSAMRAIVector());
}

double Sundials_SAMRAIVector::vecMin() const { return d_samrai_vector->min(); }

int Sundials_SAMRAIVector::constrProdPos(const SundialsAbstractVector* x) const
{
   return d_samrai_vector->computeConstrProdPos(
       SKVEC_CAST(x)->getSAMRAIVector());
}

void Sundials_SAMRAIVector::compareToScalar(const SundialsAbstractVector* x,
                                            const double c)
{
   d_samrai_vector->compareToScalar(SKVEC_CAST(x)->getSAMRAIVector(), c);
}

int Sundials_SAMRAIVector::testReciprocal(const SundialsAbstractVector* x)
{
