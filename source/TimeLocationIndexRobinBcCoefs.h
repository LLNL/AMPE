...
class TimeLocationIndexRobinBcCoefs : public solv::RobinBcCoefStrategy
{
 ...
 public:
    ...
    * @brief Destructor.
    */
   virtual ~TimeLocationIndexRobinBcCoefs();
 ...
 private:
    ...
    */
   std::vector<double> d_a_map[2 * SAMRAI::MAX_DIM_VAL];

   /*
    * @brief Mapping for b coefficient.
    */
   std::vector<double> d_b_map[2 * SAMRAI::MAX_DIM_VAL];
   /*
    * @brief Mapping for g coefficient.
    */
   std::vector<double> d_g_map[2 * SAMRAI::MAX_DIM_VAL];

   std::vector<double> d_t_map[2 * SAMRAI::MAX_DIM_VAL];
