...
//
#include "MultiOrderTernaryThreePhasesDrivingForce.h"
...
MultiOrderTernaryThreePhasesDrivingForce::
   MultiOrderTernaryThreePhasesDrivingForce(
        FreeEnergyStrategy* fenergy_strategy, const int norderp_A)
...
void MultiOrderTernaryThreePhasesDrivingForce::addDrivingForce(
