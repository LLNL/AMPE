...
typedef int (*CPRhsFn)(realtype t, N_Vector y,
		       N_Vector fout, void *user_data, int fd_flag);
...
SUNDIALS_EXPORT int CPodePrintDiagnostics(void *cpode_mem, booleantype enable);

SUNDIALS_EXPORT int CPodeSetMaxPrecondSteps(void *cpode_mem, int max_steps);
